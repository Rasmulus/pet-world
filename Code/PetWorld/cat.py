...
class Cat(PetBrain):
    """
    The class Cat represents the "brains" (or AI) of robots that move where their nose is pointing, in straight
    ...
    def move_body(self):
        """
        Moves the given "body", i.e., the robot given as a parameter. A cat first looks at the next square in the
        ...
        turnabout without finding a suitable square to move in, it ends its turn without moving. As a cat always

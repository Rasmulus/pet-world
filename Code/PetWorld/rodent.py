...
class Rodent(PetBrain):
    """
    The class Rodent represents the "brains" (or AI) of robots that move where their nose is pointing, in straight
    ...
    def move_body(self):
        ...
        turnabout without finding a suitable square to move in, it ends its turn without moving. As a rodent always
